...
##    Wxx = ndimage.filters.convolve(imx*imx,gauss, mode='same')
##    Wxy = ndimage.filters.convolve(imx*imy,gauss, mode='same')
##    Wyy = ndimage.filters.convolve(imy*imy,gauss, mode='same')
